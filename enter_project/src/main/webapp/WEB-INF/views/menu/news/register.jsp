   ...
   <div class="container news-body">
     <div class="news-intro">
       ...
       <br><br>
		...
		<form class="container" style="margin-bottom : 50px" method="post" action="<%=request.getContextPath()%>/news/register">
			...
			<div class="form-group">
				<label>내용</label>
				<textarea id="summernote" class="form-control" name="bd_content" rows="10">${board.bd_contents}</textarea>
			</div>
