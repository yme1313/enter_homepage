   		...
   		<div class="gr-body">
   			...
   			<div class="gr-content">
   				...
   				<div class="gr-con05 mb-2">
					...
					발전을 멈추지 않겠습니다. <br>
					엔터정보기술에 관심과 애정을 가지고 지켜봐 주십시오.<br>
					감사합니다. 
   				</div>
   				<div class="gr-con06">
   					엔터정보기술 대표이사 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 김   해   수  
   		...
   		<div class="gr-title flex">엔터정보기술은 고객과 함께 성장하겠습니다.</div>
 			<div class="gr-img">
   			...
   			<div class="gr-content">
   				...
   				<div class="gr-con02">
   					<div>안녕하십니까 엔터정보기술 대표이사 김해수입니다.</div>
   				...
   				<div class="gr-con04">
   					중요정보와 지식자산을 효율적으로 보호하고 ,중요정보를 체계적으로 관리할 수 있는 방안을 제시하여 고객의 경영 혁신을 선도합니다.<br> 
   				...
   				<div class="gr-con05 mb-4">
					...
					<div>엔터정보기술을 관심과 애정을 가지고 지켜봐 주십시오.</div>
					<div>감사합니다.</div> 
   				</div>
   				<div class="flex">
   					엔터정보기술 대표이사 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 김   해   수  
